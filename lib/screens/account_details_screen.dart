  ...
  Future<void> _handleDeleteAccount() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(borderRadius: AppDesignTokens.radiusLg),
        title: const Text(
          'Delete Account?',
        ...
        actions: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              ...
              shape: RoundedRectangleBorder(borderRadius: AppDesignTokens.radiusSm),
            ),
      ...
      body: SafeArea(
        child: FocusTraversalGroup(
          ...
          padding: EdgeInsets.symmetric(
            horizontal: Adaptive.pagePadding(context).left,
            vertical: 12.0,
          ),
          child: Column(
            children: [
              ...
              AppCard(
                ...
                backgroundColor: AppDesignTokens.cardPressed,
                child: Column(
                  children: [
                    Hero(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: AppDesignTokens.radiusXl,
                        border: Border.all(
                          color: isPremium ? AppDesignTokens.gold : Colors.white24,
                        ),
                      ),
                      child: Row(
                        ...
                        children: [
                          Icon(
                            ...
                            color: isPremium ? AppDesignTokens.gold : Colors.white70,
                            size: 16,
                          ),
