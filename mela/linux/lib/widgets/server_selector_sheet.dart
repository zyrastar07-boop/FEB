...
class _ServerSelectorSheetState extends State<ServerSelectorSheet>
  ...
  final List<Server> _servers = Server.defaultServers;
  ...
  void _startStreaming() {
    ...
    final server = _servers[_selectedServerIndex];

    final embedUrl = server.buildStreamUrl(
  ...
  void _onScrapeSuccess(ExtractedStreamData data) {
    if (!mounted) return;
  ...
  void _onScrapeError(String error) {
    if (!mounted) return;
    ...
    return FadeTransition(
      ...
      child: Stack(
        children: [
                  ...
                  children: [
                    Expanded(
                      ...
                      child: GestureDetector(
                        onTap: _isScraping ? null : _startStreaming,
                        child: AnimatedContainer(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                _isScraping ? 'Resolving…' : 'Stream Now',
                                style: const TextStyle(
                                  color: Colors.black,
                    ...
                    Expanded(
                      flex: 2,
                      child: GestureDetector(
                        onTap: _isScraping ? null : _startDownload,
                        child: Container(
                          height: 48,
                          decoration: BoxDecoration(
                            color: Colors.white.withValues(alpha: 0.08),
          ...
          // Scraping overlay + hidden WebView scraper
          if (_isScraping && _embedUrl != null) ...[
            Positioned.fill(
              child: Container(
                decoration: BoxDecoration(
            ...
            SizedBox(
              ...
              child: Offstage(
                ...
                child: WebViewScraper(
                  embedUrl: _embedUrl!,
                  onDataExtracted: _onScrapeSuccess,
                  onError: _onScrapeError,
                ),
              ),
            ),
          ],
